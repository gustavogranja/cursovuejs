	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="E-mail">
					<input type="text" v-model="usuario.email"> <!--Modificadores: .lazy = preenche o campo depois
					                                            de perder o foco;
					                                              .trim = preenche os espaços em brancos;
					                                              .number = usado para preencher na instância como
					                                               valor numerico e não como string -->
				</Rotulo>
				<Rotulo nome="Senha">
